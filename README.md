A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Send Invite
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-send-invite-data-action-module.git?ref=main"
    action_name        = "Send Invite"
